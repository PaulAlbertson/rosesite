...
$(document).ready(function () {
  var displaylimit = 2;
  var twitterprofile = "RosettaMktg";
  var screenname = "Rosetta Marketing";
  ...
  $('#twitter-feed').html(headerHTML + loadingHTML);
    ...
    $.getJSON('/assets/php/get-tweets.php', 
        function(feeds) {
       //alert(feeds);
            var feedHTML = '';
        ...
        //console.log(feeds[i]);
         ...
         if (((showretweets == true) || ((isaretweet == false) && (showretweets == false))) && ((showdirecttweets == true) || ((showdirecttweets == false) && (isdirect == false)))) { 
          if ((feeds[i].text.length > 1) && (displayCounter <= displaylimit)) {
            ...
            feedHTML += '<div id="tw'+displayCounter+'">';
            ...
            feedHTML += '<h4>' + status + '</h4><p class="date-time"><a href="https://twitter.com/'+tweetusername+'/status/'+tweetid+'" target="_blank">'+relative_time(feeds[i].created_at)+ '</a></p>';
...
$(document).ready(function () {
  var displaylimit = 5;
  var twitterprofile = "joelozito";
  var screenname = "Joe Lozito";
  var showdirecttweets = false;
  var showretweets = false;
  var showtweetlinks = true;
  var showprofilepic = false;
  ...
  $('#twitter-feed-technology').html(headerHTML + loadingHTML);

  $.getJSON('/assets/php/get-tweets-joe-lozito.php',
    function(feeds) {
    //alert(feeds);
      var feedHTML = '';
      var displayCounter = 1;
      for (var i=0; i<feeds.length; i++) {
        ...
        if (((showretweets == true) || ((isaretweet == false) && (showretweets == false))) && ((showdirecttweets == true) || ((showdirecttweets == false) && (isdirect == false)))) {
          if ((feeds[i].text.length > 1) && (displayCounter <= displaylimit)) {
            ...
            //feedHTML += '<div class="twitter-pic"><a href="https://twitter.com/'+tweetusername+'" target="_blank"><img src="'+profileimage+'"images/twitter-feed-icon.png" width="42" height="42" alt="twitter icon" /></a></div>';
            feedHTML += '<div class="twitter-text"><p>' + status + '<span class="tweet-time date-time">  ·  <a href="https://twitter.com/'+tweetusername+'/status/'+tweetid+'" target="_blank">'+relative_time(feeds[i].created_at)+ '</a></span></p>';
      ...
      $('#twitter-feed-technology').html(feedHTML);

      $('.grid-carousel-twitter').owlCarousel({
        items: 1,
        autoplay: true,
        loop: true,
        nav: false,
